...
from swagger_client.apis.molecules_api import MoleculesApi


class TestMoleculesApi(unittest.TestCase):
    """ MoleculesApi unit test stubs """

    def setUp(self):
        self.api = swagger_client.apis.molecules_api.MoleculesApi()
