...
//    var omics_url = url + '?mode=omics'  // geojson points
    ...
    draw_chart_repos_omics( false, domains, omics, 'species_chart' );
    draw_chart_repos_omics( false, domains, omics, 'instrument_chart' );

    function draw_chart_repos_omics(error, domains, omicstype, piechartname ) {
...
//             .attr("opacity", "0.1");
//
//            document.getElementById( spacediv_name ).innerHTML = "<br>";
